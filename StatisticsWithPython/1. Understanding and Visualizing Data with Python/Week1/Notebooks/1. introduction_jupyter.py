...
# 
# Jupyter is a web-based interactive development environment that supports multiple programming
# languages, however most commonly used with the Python programming language.
# 
# The interactive environment that Jupyter provides enables students, scientists, and researchers
# to create reproducible analysis and formulate a story within a single document.
# 
# Lets take a look at an example of a completed Jupyter Notebook:
# [Example Notebook](http://nbviewer.jupyter.org/github/cossatot/lanf_earthquake_likelihood/blob/master/notebooks/lanf_manuscript_notebook.ipynb)
...
# ### What is Markdown?
# 
# Markdown is a markup language that uses plain text formatting syntax.  This means that we can modify
# the formatting our text with the use of various symbols on our keyboard as indicators.
# 
...
# 
# To look into more examples of Markdown syntax and features such as tables, images, etc. head to the
# following link: [Markdown Reference](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)
...
# There are kernels for various programming languages, however we are solely using the python kernel
...
# A kernel is the back-end of our notebook which not only executes our python code, but
...
# prior executing cell must complete its operations prior to another cell being executed.  A cell
# still being executing is indicated by the [*] on the left-hand side of the cell.
...
# ### Command vs. Edit Mode & Shortcuts
# 
# There is an edit and a command mode for jupyter notebooks.  The mode is easily identifiable
# by the color of the left border of the cell.
# 
# Blue = Command Mode.
# 
# Green = Edit Mode.
...
# 
# Commands can be used to execute notebook functions.  For example, changing the format of a markdown
# cell or adding line numbers.
# 
...
# 
# **Note:** *Coursera provides embedded jupyter notebooks within the course, thus the download is not
# a requirement unless you wish to explore jupyter further on your own computer.*
# 
